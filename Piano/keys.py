from pygame import *
from effects import draw_keys_effect

def draw_keys(screen, key_rects, pressed_keys):
    for i, rect in enumerate(key_rects):
        is_pressed = i in pressed_keys
        draw_keys_effect(screen, rect, is_pressed)

def create_key_reacts(num_keys, start_x=50, start_y=100, key_width=100, key_height=250):
    rects = []
